...
<head>
    ...
    <script src="src/releases/1.01-20apr11/js/index/config.js"></script>
    ...
    <?php include_once("common-includes.php"); ?>
       ...
       <!--
         ...
         *********************************** -->
         ...
         <script src="src/releases/1.01-20apr11/js/index/init.js"></script>
         <script src="src/releases/1.01-20apr11/js/index/index.js"></script>
